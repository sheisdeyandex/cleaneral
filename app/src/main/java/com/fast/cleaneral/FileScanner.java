...
import static com.fast.cleaneral.ui.activities.WhitelistActivity.getWhiteList;
...
public class FileScanner {
    ...
    private com.fast.cleaneral.databinding.FragmentLoadingBinding gui;
            ...
            for (File file : foundFiles) {
                if (filter(file)) { // filter
                    ...
                    if (delete) {
                        ...
                        Log.d("sukakilo", String.valueOf(kilobytesTotal));
                        kilobytesTotal += file.length();
                    }
                }
            }
    ...
    public FileScanner setGUI(com.fast.cleaneral.databinding.FragmentLoadingBinding gui) {
        this.gui = gui;
        return this;
    }
